...
function Contact() {
  return (
     <>
    <div className='h-[85vh] w-[100%] px-[20px] bg-[#01060cff] flex justify-center items-center' id='Contact'>
        <div className='h-[30vh]'>
          ...
          <p className='text-[#b8b8b8ff] text-[17px] text-center'>I'm currently specializing in <span className='text-[#4E9FE5] '>Front-end Development</span>.</p>
            ...
            <button className='h-[40px] w-[125px] bg-[#0f1b2cff] hover:bg-[#1e3049ff] rounded-md text-white font-medium text-[17px] duration-300 ease-in-out ml-11'>Resume</button>
            ...
            <button className='h-[40px] w-[125px] bg-[#0f1b2cff] hover:bg-[#1e3049ff] rounded-md text-white font-medium text-[17px] duration-300 ease-in-out ml-4'>WhatsApp</button>
        </div>
    </div>
    </>
  )
