  ...
  return (
    <>
      ...
      <div className='flex flex-col items-center p-2'>
        ...
        <h3 className='text-white text-[55px] md:text-[85px] mb-1 font-black'>Muhammad Mujtaba</h3>
        <ReactTyped strings={["Full Stack Web Developer","Full Stack Web Developer",]} typespeed={10} backspeed={10} loop className='text-white text-[25px] md:text-[33px] font-medium' /> 
