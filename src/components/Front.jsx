  ...
  return (
    <>
      ...
      <div className='flex-col flex items-center px-1 md:pr-2'>
        ...
        <p className='text-[#b8b8b8ff] text-[15px] md:text-[19px] font-medium w-[90vw] md:w-[50vw] mt-7 mb-10'>I am an aspiring web developer with a strong foundation in HTML, CSS, Tailwind, JavaScript and React.js. Recently completed a Diploma in Information Technology (2024–2025).</p>
