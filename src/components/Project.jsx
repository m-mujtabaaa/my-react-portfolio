...
function Project() {
  return (
    <>
        <div className='w-[100%] md:w-[88%] mx-auto pt-[15vh] px-[22px]'  id='Project'>
          ...
          <div className='py-[5vh]'>
            <div className='h-[320px] md:h-[370px] w-[90vw] md:w-[45vw]  rounded-xl bg-[#061120ff] border-b-[2px] border-white'>
              ...
              <h2 className='text-white font-semibold py-3 px-4 text-[22px]'><a href="https://tech-serve-react.vercel.app/">TechServe Website</a></h2>
