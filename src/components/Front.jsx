...
function Front() {
  return (
    <>
      <div className='mx-auto flex w-[100%] md:w-[88%] pt-[25vh] px-[3px]'>
      <div className='flex-col flex items-center px-1 md:pr-2'>
        ...
        <div className='pr-[10px] md:pr-[15px]'>
        <h5 className='text-[#4E9FE5] font-semibold text-[22px] md:text-[33px] h-[25px]'>Assalam O Alaikum, I'm-</h5>
        <h3 className='text-white text-[40px] md:text-[85px] mb-1 font-black'>Muhammad <span className='text-[55px] h-[5px] md:text-[85px]'>Mujtaba</span></h3>
